...
# Descripción del proyecto
  ...
  ## Para los patrocinadores: 
    ...
    Los patrocinadores pueden elegir proyectos que se alineen con sus intereses personales y contribuir con la cantidad que les 
    sea posible.
    Además, el crowdfunding les permite tener una mayor transparencia sobre cómo se gastan los fondos del proyecto y les permite 
    involucrarse en el proceso creativo de los proyectos que apoyan.

  ## Para la comunidad en general: 
    El crowdfunding ofrece a la comunidad en general la posibilidad de apoyar ideas innovadoras y proyectos creativos que pueden 
    tener un impacto positivo en su vida o en el mundo en general. Al participar en el crowdfunding, la comunidad puede ayudar a
    dar vida a proyectos que de otra manera no habrían sido posibles. Además, el crowdfunding también puede fomentar el espíritu 
    emprendedor y la innovación en la sociedad.


## ROLES Seleccionado S7-23-t-nodereact
...
And what is?
   ...
   Crowdfunding (also known as collective financing) is an online financing model that allows people to
   and organizations raise funds from a large number of individuals through internet platforms.

How does it work?

   Crowdfunding projects are financed by small contributions from a large number of people. In general,
   projects are posted on a crowdfunding platform, where backers can read about the project and make contributions.
   Crowdfunding projects can be for anything from a new product or service to a creative project or a charitable cause.

What examples are there?

   There are different types of crowdfunding, such as reward crowdfunding (backers receive a reward for their contribution),
   loan (sponsors receive a financial return), capital (sponsors receive a share
   in the company or project) and donations (sponsors make a donation without expecting anything in return).

# Project description

   ## For project creators:
     Crowdfunding offers project creators the ability to finance their ideas in a way that previously
     I was not available. It gives them a platform to present their projects to a global audience and raise funds from
     an efficient way. Additionally, crowdfunding also gives them a way to get feedback and validate their idea.
     before investing large amounts of money in your project.

   ## For sponsors:
     Crowdfunding offers backers the chance to support projects they believe in and earn exclusive rewards.
     Backers can choose projects that align with their personal interests and contribute the amount that suits them.
     may be possible.
     In addition, crowdfunding allows them to have greater transparency on how project funds are spent and allows them to
     Get involved in the creative process of the projects they support.

   ## For the community in general:
     Crowdfunding offers the community at large the chance to support innovative ideas and creative projects that can
